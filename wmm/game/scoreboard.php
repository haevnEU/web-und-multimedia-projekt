...
<html lang="en">
    ...
    <div class="root_div root_div_color" style="width: 30%;">
        <div class="sub_div sub_div_color">
            ...
            <br>
            <br>
            <button type="button" class="custom_button custom_button_color center" onclick="location.href='/';"> <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" fill="#FFFFFF"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M20 11H7.83l5.59-5.59L12 4l-8 8 8 8 1.41-1.41L7.83 13H20v-2z"/></svg></button>
        </div>
    </div>
    </body>
    <footer class="footer">
