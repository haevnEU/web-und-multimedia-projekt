        ...
        <div class="sub_div">
            <div class="horizontal_centered">
                <form method="POST" action="./nextsptes.php">
                    ...
                    <label>
                        <input class="custom_text_input_color custom_text_input_colo" type="email" name="mail" required="required" placeholder="email" style="width: 90%;">
                    </label>
                    <br><br>
                    <label>
                        <textarea class="textarea_no_resizable textarea_no_resizable_color" name="problem" required="required" placeholder="Describe your problem as precise as possible"></textarea>
                    </label>
                    <br><br><br>
