...
<div class="root_div root_div_color" style="width: 30%;">
    <div class="sub_div sub_div_color">
        ...
        <div class="container">
            <form method="POST" action="/scripts/user_forgot_password.php">
                <div class="container">
                    <label aria-hidden="true" class="custom_input_heading">EMail *</label><br> <input aria-label="Email address" class="custom_input" type="Text" name="email" placeholder="" required="required">
                </div>
                <br>
                <div class="container">
                    <label aria-hidden="true" class="custom_input_heading">Authentication code *</label><br> <input aria-label="Authentication code" class="custom_input" type="Text" name="code" placeholder="" required="required">
                </div>
                <br>
                <div class="container">
