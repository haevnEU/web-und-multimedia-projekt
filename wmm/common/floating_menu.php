...
<div class="tooltip">
  <span class="tooltiptext">Logout</span>
    <button type="button" class="floating_button custom_button_color" onclick="location.href='/scripts/user_logout.php';">
...
<div class="tooltip">
  <span class="tooltiptext">Social [WIP]</span>
    <button type="button" class="floating_button custom_button_color" onclick="location.href='/social/popup.php';">
...
<div class="tooltip">
  <span class="tooltiptext">Account Settings</span>
    <button type="button" class="floating_button custom_button_color" onclick="location.href='/accounting/settings.php';">
...
<div class="tooltip">
  <span class="tooltiptext">Home</span>
    <button type="button" class="floating_button custom_button_color" onclick="location.href='/';">
...
<div class="tooltip">
  <span class="tooltiptext">Support</span>
    <button type="button" class="floating_button custom_button_color" onclick="location.href='/support/helpme.php';">
